...
#Rafael Olivares Andrés Criollo
#V 31331719
#Control de Estudiantes Vandalizado
...
nombres_iniciales = ["Juan", "Pablo", "Carlos", "María", "Sofía", "Cristiano", "Laura", "Diego", "Gabriela", "Daniel", "Natalia", "José", "Isabella", "Pedro", "Alejandro", "Camila", "Ana", "Valentina", "Miguel", "Edith"]
notas_iniciales = [17, 5, 11, 3, 8, 19, 6, 7, 14, 15, 16, 17, 18, 5, 11, 12, 4, 10, 19, 20]
archivo_json = "datos_estudiantes.json"

# Función para cargar datos desde un archivo JSON (si existe) o crear el archivo con datos iniciales
def cargar_datos():
    try:
        ...
        print("Archivo JSON no encontrado. Creando archivo con datos iniciales.")
        guardar_datos_en_json(nombres_iniciales, notas_iniciales)
        return nombres_iniciales, notas_iniciales
...
def nuevoEstudiante():
    while True:
        print("\nPuede escribir 'salir' y pulsar dos veces 'Enter' para dejar de agregar")
